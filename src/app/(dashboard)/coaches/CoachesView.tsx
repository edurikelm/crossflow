...
interface CoachesViewProps {
  initialCoaches: CoachWithProfile[];
}

export function CoachesView({ initialCoaches }: CoachesViewProps) {
  const [coaches, setCoaches] = useState<CoachWithProfile[]>(initialCoaches);
