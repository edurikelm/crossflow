    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-on_surface_variant mt-2 text-sm">Restablecer contraseña</p>
        </div>
          ...
          <CardContent className="relative z-10 pb-8 pt-2">
            ...
            {error && !isReady && (
              <div className="space-y-5">
                <div className="bg-error_container/50 text-error text-sm p-4 rounded-md text-center">
                  {error}
                </div>
            ...
            {isReady && (
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-surface-foreground text-sm font-medium">
